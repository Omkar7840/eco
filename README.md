...
- does not remove units, punctuation, or numbers
...
3. keep Gemini names exactly as returned, with only trim if needed
...
5. exact product preservation:
   - `exactProductName()`
6. category grouping:
   - `{ dairy: { "Amul Gold Milk 500ml": 10 } }`
